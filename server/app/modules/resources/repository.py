...
class ResourceRepository:
    ...
    SOLO maneja operaciones CRUD del modelo Resource.
    """
    ...
    def exists_by_public_id(self, public_id: str) -> bool:
        """
        Verifica si existe un resource con el public_id dado.
        """
        stmt = select(Resource).where(Resource.cloudinary_public_id == public_id)
