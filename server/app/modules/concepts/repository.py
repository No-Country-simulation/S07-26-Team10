...
class ConceptRepository:
    ...
    SOLO maneja operaciones CRUD del modelo Concept.
    """
    ...
    def get_max_display_order(
        ...
        """
        stmt = select(func.coalesce(func.max(Concept.display_order), 0)).where(
    ...
    def exists_by_name(
        ...
        """
        Verifica si existe un concepto con el mismo nombre en la misma categoría.
        """
